...
hi Constant ctermfg=8 guifg=#005cc5 gui=none cterm=none
hi String   ctermfg=30 guifg=#1C9898
hi Function ctermfg=26 guifg=#005cc5
hi Statement    ctermfg=0 guifg=#000000
hi Type     ctermfg=1 guifg=#D73A49 gui=none cterm=none
hi Number   ctermfg=30 guifg=#1C9898
hi Todo     ctermfg=15 ctermbg=88 guifg=#FFFFFF guibg=#990000
hi Special     ctermfg=1 guifg=#D73A49 gui=none cterm=none
hi Todo         ctermbg=15 ctermfg=196 guibg=#f8f8ff guifg=#ff1100 gui=underline cterm=underline
hi Label        ctermfg=0 guifg=#000000
hi StorageClass ctermfg=0 guifg=#000000
hi Structure    ctermfg=0 guifg=#000000
hi TypeDef      ctermfg=0 guifg=#000000
